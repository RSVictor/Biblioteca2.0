      ...
      <div class="d-flex align-items-center justify-content-between">
        ...
        <div class="d-flex align-items-center">
          <ul class="nav mb-2 mb-lg-0 d-flex align-items-center list-unstyled">
            ...
            <li class="nav-item">
              <a href="login.html" class="nav-link px-2 text-black">
  ...
  <div class="container">
    <div class="row mt-3 ">
      ...
      <div class="titulo-emprestimo mt-5">
        ...
        <div class="text-emp">Data emprestimo</div>
      ...
      <div class="descricao-emprestimo mt-3 ">
        <div class="card-emp"><img src="img/Programador Autodidata.png" class="card-img-top mt-2" style="height: 170px;"
            alt="...">
          <div>
