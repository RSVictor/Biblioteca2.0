    ...
    <div>
        ...
        <div class="container">
            ...
            <div class="descricao-emprestimo mt-3">
                <div class="card-emp">
                    <img src="img/Java.png" class="card-img-top mt-2" style="height: 170px;" alt="...">
                    <div>
            ...
            <div class="button-emprestimo mt-5 mb-2">
                <div class="button-emp"><a href="index.html">Adicionar</a></div>
                <div class="button-emp"><a href="#">Cancelar</a></div>
                <div class="button-emp"><a href="historico.html">Confirmar</a></div>
            </div>
        </div>
